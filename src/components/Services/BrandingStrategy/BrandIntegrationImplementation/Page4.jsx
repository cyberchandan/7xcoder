...
import guidelines from "../../../../assets/BrandIntegrationImplementation/icon/Brand Guidelines & Governance 1.png";
import identity from "../../../../assets/BrandIntegrationImplementation/icon/Brand Identity Design Systems 1.png";
import integration from "../../../../assets/BrandIntegrationImplementation/icon/Brand Integration & Implementation 1.png";
import strategy from "../../../../assets/BrandIntegrationImplementation/icon/Brand Strategy & Positioning 1.png";
import market from "../../../../assets/BrandIntegrationImplementation/icon/Market & Audience Research 1.png";
import messaging from "../../../../assets/BrandIntegrationImplementation/icon/Messaging & Communication Strategy 1.png";
import ongoing from "../../../../assets/BrandIntegrationImplementation/icon/Ongoing Brand Support & Optimization 1.png";
import scalable from "../../../../assets/BrandIntegrationImplementation/icon/Scalable Brand Architecture 1.png";

import arrow from "../../../assets/BrandIntegrationImplementation/icon/arrow1.png";
